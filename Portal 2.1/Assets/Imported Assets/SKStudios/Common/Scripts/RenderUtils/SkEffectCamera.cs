...
namespace SKStudios.Rendering {
    ...
    public class SkEffectCamera : MonoBehaviour {
            ...
            bool isSsr = false, int pixelPadding = 0, bool recursionEnabled = true)
        {
            ...
            var camTarget = headCam.targetTexture;
...
#if UNITY_2017_2_OR_NEWER
                tempDataLeft.ScreenSize = new Vector2(XRSettings.eyeTextureWidth, XRSettings.eyeTextureHeight);
#endif
...
#if UNITY_2017_2_OR_NEWER
                tempDataRight.ScreenSize = new Vector2(XRSettings.eyeTextureWidth, XRSettings.eyeTextureHeight);
#endif
