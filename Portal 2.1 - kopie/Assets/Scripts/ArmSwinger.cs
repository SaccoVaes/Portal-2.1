...
public class ArmSwinger : MonoBehaviour
{
    ...
    private Transform activeSwingController = null;
        ...
        foreach(Hand hand in player.hands)
        {
            switch (hand.handType)
            {
                case SteamVR_Input_Sources.LeftHand:
                    LeftHandPose = hand.transform;
                    break;
                case SteamVR_Input_Sources.RightHand:
                    RightHandPose = hand.transform;
                    break;
            }
        }
    }
    ...
    void FixedUpdate()
    {
        ...
        if (armSwingNavigation &&
            ...
            !rewindInProgress)
        {
            player.transform.position += variableArmSwingMotion();
        }
    ...
    {
        //auskommentiert
        headsetCollider = GetComponent<HeadsetCollider>();
