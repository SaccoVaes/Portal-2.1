...
namespace Valve.VR.Extras
{
    public class SteamVR_LaserPointer : MonoBehaviour
    {
        ...
        //public SteamVR_Action_Boolean ActivateRaycast = SteamVR_Input.GetBooleanAction("InteractUI");
        ...
        private void Update()
        {
            ...
            //if (ActivateRaycast.GetState(pose.inputSource))
                isCasting = true;
